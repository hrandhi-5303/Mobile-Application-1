...
class PhotoMemo {
  ...
  PhotoMemo.clone(PhotoMemo p) {
    ...
    photoURL = p.photoURL;
    machineLearningBy = p.machineLearningBy;
...
//a.copyFrom(b) ==> a = b
  ...
  Map<String, dynamic> toFirestoreDoc() {
    return {
      ...
      DocKeyPhotoMemo.machineLearningBy.name: machineLearningBy,
  ...
  static PhotoMemo? fromFirestoreDoc({
    ...
    return PhotoMemo(
        ...
        machineLearningBy: doc[DocKeyPhotoMemo.machineLearningBy.name] ??= 'label',
