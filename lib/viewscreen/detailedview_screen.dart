...
class _DetailedViewState extends State<DetailedViewScreen> {
  ...
  void initState() {
    ...
    setState(() {
      currentML=widget.photoMemo.machineLearningBy=="text"?"text":"label";
      con.currentMLValue=widget.photoMemo.machineLearningBy=="text"?"text":"label";
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              Text("Machine learning output",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
              Constant.devMode ? Text('${con.tempMemo.imageLabels}')
  ...
  void update() async {
    ...
    try {
      ...
      if (photo != null) {
        ...
        tempMemo.imageLabels =currentMLValue=="label"?await GoogleMLController.getImageLabels(photo: photo!):await GoogleMLController.fetchTextFromImage(photo: photo!);
        update[DocKeyPhotoMemo.imageLabels.name] = tempMemo.imageLabels;
        update[DocKeyPhotoMemo.machineLearningBy.name] = currentMLValue=="label"?"label":"text";
